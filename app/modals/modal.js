...
function closeModal() {
    ...
    if (modalContent) modalContent.classList.remove('modal-content--settings');
...
/**
 * set the modal's accessible name. The #modal-title element is referenced
...
function _trapModalFocus(e) {
    ...
    // query from modalContainer (not modalBody) so the.modal-close ×
